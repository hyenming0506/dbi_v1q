...
<script type="text/javascript">
 $(function(){
   $.removeCookie('checkId');//기존의 쿠키 값을 삭제
 });
 function checkId(){
 ...
 function checkId_res(data){
   if(data.cnt==0){
     ...
     $.cookie('checkId','PASS'); //쿠키 생성, 형식: $.cookie(쿠키 변수명, 값)
   }else if(data.cnt==1){
  ...
  <fieldset>
    <ul>
      ...
      <li>
        ...
        <input type='text' name='address1' id='address1' value='' size='40' placeholder="주소">  
        <input type='text' name='address2' id='address2' value='' size='15' placeholder="상세 주소">      
      </li>
      <li>
